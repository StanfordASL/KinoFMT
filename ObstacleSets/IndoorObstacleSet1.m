% IndoorObstacleSet1 gives a set of obstacles for the ASL vicon arena
%
...
function [LWH_F, YPR_F, CM_F] = IndoorObstacleSet1(obstacles)
...
LWH_F = [...
    ...
    [0.1, 0.1, 1.0]', ...
    [0.1, 0.1, 1.0]'];
LWH_F = LWH_F.*repmat([envL, envW, envH]', 1, 4);
...
CM_F = [...
    ...
    [0.75, 0.75, 0.5]', ...
    [0.25, 0.75, 0.5]'];
CM_F = CM_F.*repmat([envL, envW, envH]', 1, 4) + ...
	repmat([obstacles.obstacleSpace(1,1), ...
	 obstacles.obstacleSpace(2,1), ...
	obstacles.obstacleSpace(3,1)]', 1, 4);
