...
% Data Storage
savefile = 'DSSC_Para_5000x10000x10_Sep25-2014';
...
sampling.nTot2PBVPs = 10000;	%(#) number of 2pt BVPs to solve for trainng ML
sampling.nTrajNodes = 10;	%(#) number of disctrete points for optimal control subproblems

% Robot Parameters
robot.mass = 1.0;           %(m/s) horizontal velocity
robot.thrustMax = 0.1;      %(rad/s) maximum turnrate
...
learning.nMLTrainingSamples = 9700;      	% (#) number of training examples for ML. NaN->use all samples
...
% Call Planner
mpinfo = DSSCParaMotionPlannerInitial(mpinfo, 0);
