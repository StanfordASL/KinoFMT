%   DSSCInitialGuess.m: Generate a starting guess for optimization 
%
...
function [vars_0, probinfo] = DSSCInitialGuess(probinfo)
...
% Assemble Variables
vars_0 = DSSCAssembleVariables(x_0, y_0, z_0, xdot_0, ydot_0,...
