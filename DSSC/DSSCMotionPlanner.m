%DSSCMotionPlanner solves a motion planning problem for the DSSC system
%
...
function [mpinfo] = DSSCMotionPlanner(mpinfo, planningPhase)
...
if planningPhase <= 4
    ...
    mpinfo = DSSCSolve2PBVPsRemainingSet(mpinfo);
