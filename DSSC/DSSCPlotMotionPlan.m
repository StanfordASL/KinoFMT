...
function DSSCPlotMotionPlan(mpinfo)
...
figure('Color',[1 1 1])
%tightplot = tight_subplot(2,2,.05,0.01,0.01)
%axes(tightplot(1));
%subplot('Position',[0.0 0.5 0.5 0.5])
%subplot(2,2,4)
...
%tight_subplot(2,2,3, 0.05,0.01,0.01)
%axes(tightplot(2));
%subplot('Position',[0.0 1.0 0.5 0.5])
subplot(2,2,3)
hold on
if isfield(mpinfo.obstacles, 'cuboids')
    faceVertexIndices       = obstacles.cuboids.faceVertexIndices;  % Cn1
...
%tight_subplot(2,2,2,0.05,0.01,0.01)
%axes(tightplot(3));
