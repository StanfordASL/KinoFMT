%   DSSCNonLinearConstraints.m: Compute nonlinear constraints and gradients 
%
...
function [c, ceq, dcdx, dceqdx] = DSSCNonLinearConstraints(vars,probinfo)
...
function [ceq, ncons] = NonlinearEqualityConstraints(vars,probinfo)
    ...
    % Extract Variables
    [x,y,z,xdot,ydot,zdot,ux,uy,uz,eta,tf] = DSSCDecomposeVariables(vars, probinfo.numerics.range);
