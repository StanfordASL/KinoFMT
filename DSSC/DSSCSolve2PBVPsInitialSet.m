% DSSCSolve2PBVPsInitialSet solves a subset of all possible optimal 
...
function [ mpinfo ] = DSSCSolve2PBVPsInitialSet( mpinfo)
...
if nTot2PBVPs > nSamples^2
    ...
    disp('Prematurely exiting DSSCSolve2PBVPs...')
    return
end
...
for i = 1:nTot2PBVPs
    ...
    % Call Solver
    probinfo = DSSCOptimizer(probinfo);
