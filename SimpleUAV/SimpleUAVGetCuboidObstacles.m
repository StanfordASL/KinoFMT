% SimpleUAVGetCuboidObstacles generates and and stores cuboid obstacles
...
function mpinfo = SimpleUAVGetCuboidObstacles(mpinfo)
...
if size(obstacles.obstacleSpace,1) > size(mpinfo.sampling.stateSampleRange,1)
    ...
    disp('Exiting SimpleUAVGetCuboidObstacles prematurely...')
    return
end
