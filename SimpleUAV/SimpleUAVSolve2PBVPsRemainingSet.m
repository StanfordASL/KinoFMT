% SimpleUAVSolve2PBVPsRemainingSet solves the remaining set of optimal
...
function [ mpinfo ] = SimpleUAVSolve2PBVPsRemainingSet( mpinfo )
...
%         disp([num2str(i), ', ', num2str(j)])
        if i ~= j && evalMat(i,j) == 0 % non trivial and has not been evaluated
            ...
            if curReachPred == 1
                ...
                boundary_values.theta0 = curInitState(4);
                ...
                boundary_values.thetaf = curFinalState(4);
                ...
                % Call solver
                bvpinfo = SimpleUAVOptimizer(bvpinfo);
                ...
                if bvpinfo.solution.exitflag > 0
                    ...
                    trajMat(n2PBVPs,4,:) = bvpinfo.solution.theta;
                    controlMat(n2PBVPs,1,:) = bvpinfo.solution.utheta;
                    controlMat(n2PBVPs,2,:) = bvpinfo.solution.uz;
                end
            end
        end
    end
