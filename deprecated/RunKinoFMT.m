% RunKinoFMT executes the kinodynamic Fast Marching Trees algorithm 
%
...
function mpinfo = RunKinoFMT(mpinfo)
...
while isempty(uniqueIntersect(Vgoal, z))
    ...
    for j = 1:length(Xnear)
        ...
        % Check Collision (currently assumes 3 spacial dimensions)
