%   DeepSpaceNumericData.m: Compute Chebyshev differentiation, non-dimensional time vector, 
...
function probinfo = DeepSpaceNumericData(probinfo)
...
probinfo.numerics.range.xdot = 3*n+1:4*n;
probinfo.numerics.range.ydot = 4*n+1:5*n;
probinfo.numerics.range.zdot = 5*n+1:6*n;
...
probinfo.numerics.range.tf = 10*n+1;
