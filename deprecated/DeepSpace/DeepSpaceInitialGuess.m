%   DeepSpaceInitialGuess.m: Generate a starting guess for optimization 
%
...
function [vars_0, probinfo] = DeepSpaceInitialGuess(probinfo)
...
xdot_0 = vel(1)*ones_vector;
ydot_0 = vel(2)*ones_vector;
zdot_0 = vel(3)*ones_vector;
...
% Assemble Variables
vars_0 = DeepSpaceAssembleVariables(x_0, y_0, z_0, xdot_0, ydot_0,...
    zdot_0, ux_0, uy_0, uz_0, eta_0, tf_0);
