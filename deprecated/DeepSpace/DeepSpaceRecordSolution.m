%   DeepSpaceRecordSolution.m: Store and dimensionalize results data
%
...
function probinfo = DeepSpaceRecordSolution(vars_opt, J_opt, probinfo,...
    exitflag, solveroutput)

range = probinfo.numerics.range;
scale = probinfo.scale;
[x,y,z,xdot,ydot,zdot,ux,uy,uz,eta,tf] = DeepSpaceDecomposeVariables(vars_opt, range);
