%   DeepSpaceDecomposeVariables.m: Separate optimization design variable into 
...
function [x,y,z,xdot,ydot,zdot,ux,uy,uz,eta,tf] = DeepSpaceDecomposeVariables(vars, range)
